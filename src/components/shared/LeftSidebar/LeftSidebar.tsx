    ...
    return (
        ...
        border-r border-zinc-200 bg-zinc-50 p-6 pt-36 max-sm:hidden lg:w-[266px] dark:border-zinc-900 dark:bg-zinc-900">
            ...
            <div className="mt-5 flex flex-col gap-5">
                <Link to="/sign-in">
                    <Button className="body-semibold btn-secondary min-h-[41px] w-full rounded-lg text-zinc-50">
                        <LucideUserCircle className="w-5 h-5 lg:hidden" />
                        <span className="max-lg:hidden">Log In</span>
                    </Button>
                </Link>
                <Link to="/sign-up">
                    <Button className="body-semibold btn-tertiary min-h-[41px] w-full rounded-lg text-zinc-50">
                        <LucideUserX2 className="w-5 h-5 lg:hidden" />
